...
见 [skill_agent.py](skill_agent.py) 和 [skills/example-reviewer/SKILL.md](skills/example-reviewer/SKILL.md)。
...
```bash
uv run --env-file .env python examples/05_skills/skill_agent.py
```
